...
contract CultBearsV2Base is ONFT721, ReentrancyGuard, ERC2981, Pausable {
    ...
    constructor(
        ...
        tokenIDRange[TokenRarityType.MYTHIC] = TokenIDRange(1001, 2);
        tokenIDRange[TokenRarityType.LEGENDARY] = TokenIDRange(1003, 13);
        tokenIDRange[TokenRarityType.ULTRA_RARE] = TokenIDRange(1016, 25);
        tokenIDRange[TokenRarityType.RARE] = TokenIDRange(1041, 50);
        tokenIDRange[TokenRarityType.COMMON] = TokenIDRange(1091, 910);
    }
